...
/**
 * RecursiveBTContLoading2Thread
 * 
 * Prueba de implementacion con hilos del algoritmo de backtracking recursivo
 * para el problema de la carga contenerizada del ejercicio 2 de la practica 4.
 * 
 * @author Antonio José Jiménez Luque
 * @author Adrián Jiménez Benítez
 */
public class RecursiveBTContLoading2Thread extends Thread {
    ...
    public RecursiveBTContLoading2Thread(int actual, int nivel, int cpus) {
        pesoActual = actual;
        máximoConseguido = 0;
        this.nivel = nivel;
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Se ha tardado %,.0f ms para %d elementos en UN núcleo.\n",
                (float) (System.currentTimeMillis() - tiempo), cantidad);
